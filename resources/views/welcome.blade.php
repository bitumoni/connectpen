        ...
        <main class="flex-shrink-0">
            ...
            <section class="py-5" id="features">
                <div class="container px-5 my-5">
                    <div class="row gx-5">
                        <div class="col-lg-4 mb-5 mb-lg-0"><h2 class="fw-bolder mb-0">A better way to start earning money.</h2></div>
                        <div class="col-lg-8">
                            <div class="row gx-5 row-cols-1 row-cols-md-2">
                                <div class="col mb-5 h-100">
                                    ...
                                    <p class="mb-0">An author is a user responsible for typing creative stories published in formats such as books, movies, or television scripts.</p>
                                </div>
                                <div class="col mb-5 h-100">
                                    <div class="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i class="bi bi-building"></i></div>
                                    <h2 class="h5">Publisher</h2>
                                    <p class="mb-0">Publisher can prepares and issues books, journals, or author thoughts for sale.</p>
                                </div>
                                <div class="col mb-5 mb-md-0 h-100">
                                    <div class="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i class="bi bi-toggles2"></i></div>
                                    <h2 class="h5">Investor</h2>
                                    <p class="mb-0">An investor is a user that allocates capital with the expectation of a future financial return or to gain an advantage. Through this allocated capital most of the time the investor purchases some contents.</p>
                                </div>
                                <div class="col h-100">
                                    <div class="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i class="bi bi-toggles2"></i></div>
                                    <h2 class="h5">Admin</h2>
                                    <p class="mb-0">Admin is for developers.</p>
                                </div>
                            </div>
                        </div>
                    </div>
